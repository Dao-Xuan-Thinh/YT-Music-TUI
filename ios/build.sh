...
# Bake the current commit into the app so UpdateChecker can compare against GitHub.
SHA=$(git rev-parse HEAD 2>/dev/null || echo unknown)
cat > YTMusic/BuildInfo.generated.swift <<EOF
// Generated by build.sh — never edit or commit (gitignored).
enum BuildInfo {
    static let sha = "$SHA"
}
EOF
